...
let navigate=useNavigate();
  ...
  return (
    <div className='bg-gradient-to-r from-[#f09433] via-[#e6683c] to-[#dc2743] h-screen flex flex-col items-center'>
    <div className='bg-white w-fit flex flex-col items-center justify-center m-[10px] pt-[50px] pb-[20px] px-[30px]  mt-[50px] rounded-sm bg-opacity-30 border-black border'>
      <div className="logo flex flex-col items-center">
        ...
        <p className='text-gray-600 w-[70%] text-center text-xs font-bold my-[20px]'>Sign in to see photos and videos from your friends</p>
      </div>

      <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col items-center gap-[10px]'>
        <input required {...register('email')} name='email' className='border-black border outline-none px-[4px] rounded-sm w-[130%]' type="email" placeholder='Email' />
        <input required {...register('password')} name='password' className='border-black border outline-none px-[4px] rounded-sm w-[130%]' type="password" placeholder='Password' />
        <input className='border-black border w-[125%] bg-blue-700 text-white cursor-pointer rounded-sm outline-none' type="submit" value="Sign Up" />
      </form>

      <p className='text-gray-600 w-[80%] justify-center text-xs font-bold my-[15px] mt-[40px] flex flex-wrap'>Do not have an account? <Link className='hover:underline' to='/signup'>Sign Up</Link> </p>
    </div>
    </div>
  )
}
