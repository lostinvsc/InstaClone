...
let navigate=useNavigate()
    ...
    const onSubmit = async (data) => {
        ...
        if (!emailRegex.test(data.email)) {
            ...
            alert("Password must be 8 characters or longer and contain at least 1 lowercase, 1 uppercase alphabetical, 1 numeric, 1 special(ex @, $ ) character")
            return;
        }
