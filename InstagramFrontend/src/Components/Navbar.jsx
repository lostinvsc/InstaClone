...
const Navbar = () => {
    ...
    const [logoutbtn, setLogout] = useState(0)
    let navigate = useNavigate();
    const logout = async () => {
        if (logoutbtn == 2) {
            let req = await axios.get('/logout', {
    ...
    const getmodal=()=>{
        if(logoutbtn==1){
            return <Modal logoutbtn={logoutbtn} setLogout={setLogout}/>
          }
    }
